...
namespace Improbable.Gdk.PlayerLifecycle
{
    public partial class OwningWorker
    {
        public class EcsViewManager : IEcsViewManager
        {
            ...
            {
                global::Improbable.Gdk.PlayerLifecycle.OwningWorker.ReferenceTypeProviders.WorkerIdProvider.CleanDataInWorld(world);
            }
            ...
            private void AddComponent(EntityId entityId)
            {
                ...
                component.workerIdHandle = global::Improbable.Gdk.PlayerLifecycle.OwningWorker.ReferenceTypeProviders.WorkerIdProvider.Allocate(world);
            ...
            private void RemoveComponent(EntityId entityId)
            {
                ...
                global::Improbable.Gdk.PlayerLifecycle.OwningWorker.ReferenceTypeProviders.WorkerIdProvider.Free(data.workerIdHandle);
