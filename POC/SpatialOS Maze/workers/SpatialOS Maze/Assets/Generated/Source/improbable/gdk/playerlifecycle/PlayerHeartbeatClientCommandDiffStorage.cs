...
namespace Improbable.Gdk.PlayerLifecycle
{
    public partial class PlayerHeartbeatClient
    {
        ...
        {
            private readonly MessageList<PlayerHeartbeat.ReceivedRequest> requestStorage =
                new MessageList<PlayerHeartbeat.ReceivedRequest>();

            private readonly MessageList<PlayerHeartbeat.ReceivedResponse> responseStorage =
            ...
            public MessagesSpan<PlayerHeartbeat.ReceivedRequest> GetRequests()
            {
                return requestStorage.Slice();
            }

            public MessagesSpan<PlayerHeartbeat.ReceivedRequest> GetRequests(EntityId targetEntityId)
            {
                if (!requestsSorted)
                {
            ...
            public MessagesSpan<PlayerHeartbeat.ReceivedResponse> GetResponses()
            {
                return responseStorage.Slice();
            }

            public MessagesSpan<PlayerHeartbeat.ReceivedResponse> GetResponse(long requestId)
            {
                if (!responsesSorted)
                {
                ...
                return responseIndex.HasValue
                    ...
                    : MessagesSpan<PlayerHeartbeat.ReceivedResponse>.Empty();
            }
        ...
        {
            private readonly MessageList<CommandRequestWithMetaData<PlayerHeartbeat.Request>> requestStorage =
                new MessageList<CommandRequestWithMetaData<PlayerHeartbeat.Request>>();

            private readonly MessageList<PlayerHeartbeat.Response> responseStorage =
