...
namespace Improbable.Gdk.PlayerLifecycle
{
    public partial class PlayerCreator
    {
        ...
        {
            private readonly MessageList<CreatePlayer.ReceivedRequest> requestStorage =
                new MessageList<CreatePlayer.ReceivedRequest>();

            private readonly MessageList<CreatePlayer.ReceivedResponse> responseStorage =
            ...
            public MessagesSpan<CreatePlayer.ReceivedRequest> GetRequests()
            {
                return requestStorage.Slice();
            }

            public MessagesSpan<CreatePlayer.ReceivedRequest> GetRequests(EntityId targetEntityId)
            {
                if (!requestsSorted)
                {
            ...
            public MessagesSpan<CreatePlayer.ReceivedResponse> GetResponses()
            {
                return responseStorage.Slice();
            }

            public MessagesSpan<CreatePlayer.ReceivedResponse> GetResponse(long requestId)
            {
                if (!responsesSorted)
                {
                ...
                return responseIndex.HasValue
                    ...
                    : MessagesSpan<CreatePlayer.ReceivedResponse>.Empty();
            }
        ...
        {
            private readonly MessageList<CommandRequestWithMetaData<CreatePlayer.Request>> requestStorage =
                new MessageList<CommandRequestWithMetaData<CreatePlayer.Request>>();

            private readonly MessageList<CreatePlayer.Response> responseStorage =
